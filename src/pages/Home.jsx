        ...
        <div className="max-w-7xl mx-auto px-3 h-full flex items-center">
          <div className="text-center lg:w-1/2 lg:text-left lg:pr-16 relative z-40">
            ...
            <p className="text-white lg:text-gray-600 leading-loose mb-12">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Beatae quia tenetur
              consectetur voluptas deleniti iure quas aliquam laboriosam fuga quos.
            </p>
            <Link to="/login" className="btn btn-secondary normal-case mr-2 mb-4 w-48">
              List your house
            </Link>
